  ...
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
      ...
      <span className="relative inline-block mt-2">
        <span className="absolute -inset-2 bg-gradient-to-r from-[#6366f1] to-[#a855f7] blur-2xl opacity-20"></span>
        <span className="relative bg-gradient-to-r from-[#6366f1] to-[#a855f7] bg-clip-text text-transparent text-[50px]">
...
const WORDS = ["Web Development", "Tech Knowledge", "Digital Marketing ", "Content Creation", "Entrepreneurship"];
const TECH_STACK = [ "Tech Knowledge", "Digital Marketing", "Entrepreneurship"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ramadhannezz" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ramadhan0801/" },
  { icon: Instagram, link: "https://www.instagram.com/ramkative" }
];
